...
export const eventRsvpAutomation: CaseStudy = {
  ...
  summary:
    "An end-to-end event registration and RSVP management platform built using AI-assisted automation workflows, designed to eliminate manual guest tracking.",
  problem:
  ...
  approach:
    "We designed a fully automated pipeline that captures registrations, verifies guest identities, sends dynamic calendar invites, and provides real-time dashboard visibility to organizers without requiring any manual data entry.",
