      ...
      <main className="pt-32 pb-24">
        <article className="mx-auto max-w-4xl px-5">
          <Reveal>
            ...
            <p className="mb-12 text-xl text-muted-foreground leading-relaxed">{project.summary}</p>
          </Reveal>
            ...
            <Reveal>
              ...
              <ul className="space-y-4">
                {project.results.map((result) => (
                  <li
                    key={result}
                    className="flex items-start gap-4 rounded-xl border border-border/60 bg-background p-4 shadow-sm"
                  >
